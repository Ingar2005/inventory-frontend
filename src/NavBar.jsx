...
export default function CrudButtons({url}){
    ...
    return(<div className="flex flex-col ">
            ...
            <button className="flex-initial bg-steel-blue-500 pd px-6 py-2 mx-2.5 my-1 text-white rounded-md hover:rounded-lg  hover:bg-steel-blue-600 #517bbd  " onClick={() => console.log(" pressed") }>settings</button>
            </nav>
            <Outlet  />
        </div>
    )
